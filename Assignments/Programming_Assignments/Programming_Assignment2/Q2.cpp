...
string encrypt(string pt, vector<string> rkb, vector<string> rk)
{
	...
	for (int i = 0; i < 16; i++) {
        ...
        cout<<"expanded bits:"<<right_expanded<<endl;
		...
		// Straight P-box
		cout << "S - Box: " << op << endl;
		string p_box = permute(op, per, 32);
        cout<<"P - Box: "<< p_box << endl;
		// XOR left and op
		x = xor_(op, left);
